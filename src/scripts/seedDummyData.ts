...
const SEED_PROJECTS: Array<{
...
}> = [
  {
    ...
    description:
      'Layanan pemendek URL yang sangat cepat dan efisien, dilengkapi dengan fitur analitik klik dasar.',
  ...
  },
  {
    title: 'Portfolio CMS',
    description:
      'Sistem manajemen konten headless (API-first) untuk mengelola data portofolio secara dinamis dan aman.',
  ...
  },
  {
    ...
    description:
      'Microservice autentikasi terpusat yang aman, diimplementasikan menggunakan standar token JWT.',
  ...
  },
  {
    ...
    description:
      'Sistem informasi manajemen stok barang komprehensif untuk pencatatan transaksi dan pelaporan.',
    stack: 'Laravel, MySQL',
  ...
  },
  {
    ...
    description:
      'Aplikasi mobile produktivitas luring (offline-first) untuk mengelola tugas harian pengguna.',
  ...
  },
  {
    ...
    description:
      'Layanan API gateway webhook untuk memicu dan mengirimkan notifikasi WhatsApp secara otomatis.',
...
const SEED_SKILLS: Array<{ name: string; category: string }> = [
...
const SEED_EXPERIENCES: Array<{
...
}> = [
  {
    ...
    description:
      'Magang kejuruan dengan fokus pada pengembangan aplikasi web dan arsitektur API modern menggunakan ekosistem berbasis TypeScript.',
  ...
  },
  {
    ...
    description:
      'Pendidikan kejuruan (SMK) yang berfokus pada fundamental pemrograman, pengembangan web, dan rekayasa perangkat lunak.',
